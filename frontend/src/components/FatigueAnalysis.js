      ...
      <div className="content-grid">
        ...
        <div className="text-content">
          <div className="text-content-inner">
            ...
            <p>
              VISTA's Fatigue Analysis services provide comprehensive assessment of structural components 
              under cyclic loading conditions. Our expert team utilizes advanced methodologies and tools 
              to predict component life and identify potential failure points before they occur.
            </p>
            <p>
